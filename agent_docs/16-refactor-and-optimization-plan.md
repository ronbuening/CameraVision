...
| C6–C18 | pending | | Maintainer-approved execution order is C6–C14, C16, C15, C17, C18. This deliberately executes C15 before its stated D4 dependency so Tranche C can complete before Tranche D; preserve behavior and resolve any later D4 overlap deliberately. |
| D1–D7 | pending | | |
