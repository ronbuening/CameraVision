...
| C18 | pending | | Maintainer-approved remaining execution order is C18. C15 was deliberately completed before its stated D4 dependency so Tranche C can finish before Tranche D; preserve the split boundaries and resolve any later D4 overlap deliberately. |
| D1–D7 | pending | | |
