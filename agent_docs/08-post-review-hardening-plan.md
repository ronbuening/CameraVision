...
open because no live pre-change batch baseline was captured; see plan 10 R4-6 for the recorded
decision, verification results, and exact remaining evidence item.
