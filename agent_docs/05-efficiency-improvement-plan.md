...
>
> **Implementation status (2026-07-11):** complete in R4-6. Two order-reversed runs on the 46-image
> repository corpus reduced aggregate median/mean/p90 render timing by 14–17%; full methodology
> and measurements are recorded in plan 10's R4-6 acceptance ledger.
