...
- **M8a — Settings expansion and model picker** (FR4-056/057, AC4-032/033; requirements v0.8, extended by R3-5) ✅ done. See `Features/Settings/` (`SettingsModel`, `SettingsSheet`), built on CORE-8/9; R3-5 adds persisted model timeout/retry controls; replaces the M0 About sheet; Studio adopts it in M9.
