...
1. `agent_docs/07-cupricaspect-gui-design.md` — the binding visual design spec (tokens, aperture component, per-screen layouts). The design handoff bundle it was extracted from lives in `agent_docs/archive/gui-wrapper-for-cameravision/`.
