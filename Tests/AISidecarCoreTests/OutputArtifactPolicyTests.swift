...
final class OutputArtifactPolicyTests: XCTestCase {
    func testNormalizeDefaultArtifactPlacementUsesInputBasePath() {
        ...
        XCTAssertEqual(plan.sessionPath, "/photos/batch/normalization-session-2027-01-15T08:00:00Z.json")
        XCTAssertEqual(plan.reportPath, "/photos/batch/normalization-report-2027-01-15T08:00:00Z.json")
        XCTAssertEqual(plan.summaryPath, "/photos/batch/normalization-summary-2027-01-15T08:00:00Z.md")
        XCTAssertEqual(plan.progressPath, "/photos/batch/normalization-progress-2027-01-15T08:00:00Z.jsonl")
    ...
    func testApplySessionReadsOriginalSessionAndWritesSeparateApplyArtifacts() {
        ...
        XCTAssertEqual(plan.summaryPath, "/tmp/applied/normalization-apply-summary-2027-01-15T08:00:00Z.md")
        XCTAssertEqual(plan.progressPath, "/tmp/applied/normalization-apply-progress-2027-01-15T08:00:00Z.jsonl")
